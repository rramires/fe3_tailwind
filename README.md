...
3 - Para testar, adicione alguns estilos no return do nosso layout em **\_layouts/app.tsx**:
...
4 - Adicione alguns estilos na nossa página Dashboard em **dashboard.tsx**:
...
- Veja tamtém a ordem classificação das classes, invertendo a ordem
  **'font-bold text-3xl'** e vendo que volta para **'text-3xl font-bold'** quando salva, graças ao prettier-plugin-tailwindcss.

5 - Adicione também alguns estilos no return do nosso layout em **\_layouts/auth.tsx**:
...
- Lembrando que para testar essas páginas de erro devemos:  
  Usar uma rota inexistente **http://localhost:3001/other** para ver o **e404.tsx** sendo renderizado.
    ...
    Provocar um erro em alguma página: descomentando: **throw new Error('Dashboard error simulation')**, e ir para **http://localhost:3001/**, para ver o **error.tsx** sendo renderizado.
